...
RSpec.describe "fair_mkt_rents/new", type: :view do
  before(:each) do
    assign(:fair_mkt_rent, FairMktRent.new(
      :fmr0 => "MyString",
      :fmr1 => "MyString",
      :fmr2 => "MyString",
      :fmr3 => "MyString",
  ...
  it "renders new fair_mkt_rent form" do
    render

    assert_select "form[action=?][method=?]", fair_mkt_rents_path, "post" do
